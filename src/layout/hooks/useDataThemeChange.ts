...
export function useDataThemeChange() {
  ...
  function setLayoutThemeColor(
    ...
    const activeTextColor = "var(--app-accent-foreground)";
  ...
  // Primary scales are generated from semantic roles in applyAppTheme.
  /** 设置 `element-plus` 主题色 */
  const setEpThemeColor = (color: string) => {
    ...
    // Element Plus compatibility scales are all generated by applyAppTheme.
  };

  /** 浅色、深色整体风格切换 */
  function dataThemeChange(overall?: string) {
    overallStyle.value = overall;
    document.documentElement.classList.toggle("dark", Boolean(dataTheme.value));
